...
python -u main_open_world.py \
    --modelname ow_dab_detr --output_dir ${EXP_DIR} --dataset owod --num_queries 100 --eval_every 5 \
    --PREV_INTRODUCED_CLS 0 --CUR_INTRODUCED_CLS 19 --data_root 'data/VOC2007/OWDETR' --train_set 't1_train' --test_set 'test' --num_classes 81 \
